...
export const MockProjects = [
    ...
    new Project({
        id: 2,
        name: 'Kunze, Kihn and Kunde',
        description: 'Multi-channelled 24 hour knowledge user. Quia voluptatem voluptatem voluptatem.',
        imageUrl: '/assets/placeimg_500_300_arch1.jpg',
        contractTypeId: 4,
        contractSignedOn: '2012-08-06T21:21:41.473Z',
        budget: 91638,
        isActive: true,
    }),
    new Project({
